"""Debug script to test error message with empty medication_ids."""
...
async def test_error_message_empty_ids():
    """Test the error message generation when medication_ids is empty or wrong."""
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        if not matching_meds:
            ...
            print(f"\nError message:\n{error_message}")
            print("\n--- This is the bug! The scheduled times list is empty! ---")


if __name__ == "__main__":
    asyncio.run(test_error_message_empty_ids())
