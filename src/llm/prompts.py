...
- Это нужно для правильного формирования сообщения "аспирин удален", "габапентин удален"
- Примеры: "аспирин" (не "аспирина"), "габапентин" (не "габапентина"), "ламотриджин" (не "ламотриджина")
...
ВАЖНО О ГРАММАТИКЕ:
- Поле "medication_name" должно содержать название медикамента в РОДИТЕЛЬНОМ ПАДЕЖЕ (genitive case)
- Это нужно для правильного формирования сообщения "Время приема аспирина изменено", "Время приема ламотриджина изменено"
- Примеры: "аспирина" (не "аспирин"), "габапентина" (не "габапентин"), "ламотриджина" (не "ламотриджин")
- Название должно быть в нижнем регистре
